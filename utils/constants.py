class Constants:
    ...
    CONTRACTION_MAPPING_DICT: dict[str, str] = {"ain't": "is not", "aren't": "are not", "can't": "cannot",
                                                "'cause": "because",
    ...
    PUNCTUATION_MAPPING_DICT: dict[str, str] = {"‘": "'", "₹": "e", "´": "'", "°": "", "€": "e", "™": "tm",
                                                "√": " sqrt ", "×": "x", "²": "2",
                                                "—": "-", "–": "-", "’": "'", "_": "-",
                                                "`": "'", '“': '"', '”': '"', '“': '"', "£": "e", '∞': 'infinity',
                                                'θ': 'theta', '÷': '/',
    ...
    MIS_SPELLING_DICT: dict[str, str] = {'colour': 'color', 'centre': 'center', 'favourite': 'favorite',
                                         ...
                                         'narcissit': 'narcissist', 'bigdata': 'big resources', '2k17': '2017',
                                         '2k18': '2018',
                                         'qouta': 'quota',
